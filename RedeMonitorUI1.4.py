...
# ------------------------------------------
# TEMPLATES - LINK SPEED (skin "Network")
# ------------------------------------------
...
# ------------------------------------------
# TEMPLATE - SYSTEM.INI (skin "illustro\System")
# ------------------------------------------
...
def montar_subaba_system(parent):
    ...
    ttk.Label(header_sistema, text="Bloco System", font=("Segoe UI", 16, "bold")).pack(anchor="w")
    ...
    botao_aplicar_sistema.pack(side="right")
